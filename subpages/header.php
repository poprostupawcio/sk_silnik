...
<html>
  ...
  <body>
    <ul>
      <?php
      session_start();
      echo '<li><a href="page_list.php">Lista podstron</a></li>';
      echo '<li><a href="add_subpage.php"> Dodaj podstronę</a> </li>';
      echo '<li><a href="../add_content/add_content.php"> Dodaj treść do podstrony </a></li>';
      echo '<li><a href="../sell/add_sell.php"> Dodaj ofertę sprzedaz</a> </li>';
      echo '<li><a href="../sell/sell_list.php"> Lista ofert sprzedazy</a> </li>';
